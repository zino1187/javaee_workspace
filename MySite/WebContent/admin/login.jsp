...
<%
	...
	*/
	...
	if(mid.equals(admin_id) &&  password.equals(admin_pass)){
		...
		//이 세션은 클라이언트가 브라우저를 종료하지 않거나, 일정시간내에 재접속을 할 경우 계속 사용할 수 있다..
		//따라서 웹은 stateless 기반이지만, 서버측의 메모리에 생성된 세션을 이용하면 마치 연결이 유지된 것처럼 보여질수
		//있다..주 용도) 로그인 후 회원정보를 모든 페이지에서 사용할수있는 기능, 장바구니 등에 사용...
